...
angular.module('weatherApp')
  .directive('d3Bars',['cities','d3','$window','$filter','colors','$rootScope','usSpinnerService',function (cities,d3,$window,$filter,colors,$rootScope,usSpinnerService) {
    return {
      ...
      link: function postLink(scope, element,attrs) {
         ...
         scope.$watch(function() {
           ...
           if(cities.cities[0].history && cities.graphSet)
           {
         ...
         if(cities.cities[0].history && cities.graphSet) //sometimes the service populates the graph data before the d3bars directive is created, this checks for that.
         {
           render();
